        ...
        <footer className=''>
            <div className='row px-5'>
                <div className='col-12 col-md-6 p-2 d-flex align-items-center'>
                    <b className='wave d-flex align-items-center p-1'><span>Sonando:</span> &nbsp; <Pulse paused={radio.radio ? radio.radio.paused : false} color={radio.radio.paused ? '#ababab' : '#eb0000'} height='0.5em' width='0.5em'/>&nbsp;</b>
